            ...
            <form
                ...
                <div className="flex flex-wrap justify-between">
                    <div className="w-full lg:w-brand-46 mt-6">
                        ...
                        <input type="text" placeholder="Joe Bloggs" className="block rounded-lg shadow-brand-xs h-10 pl-2 w-full mr-8" name="name" id="name" />
                    </div>
                    <div className="w-full lg:w-brand-46 mt-6">
                        <label className="text-xs">Email*</label>
                        <input type="email" placeholder="joe.bloggs@gmail.com" className="block rounded-lg shadow-brand-xs h-10 pl-2 w-full" name="email" id="email" />
                    </div>
                    <div className="w-full mt-6">
                        <label className="text-xs">Message*</label>
                        <textarea placeholder="Tell me a little about your WordPress project..." className="block rounded-lg shadow-brand-xs p-2 w-full h-48" name="message" id="message" />
                    </div>
