  ...
  return (
    <Layout>
      ...
      <Intro
        title="Themes"
        text={`
          <p>Custom open source WordPress Themes I've built in my spare time. Most are based on genuine designs I've found on sites like <a href="https://dribbble.com">dribbble</a>.</p>
          `}
      />
